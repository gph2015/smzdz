...
<%@ include file="../common/head.jsp" %>
    <div id="rightContent">
        <div>当前位置:<span class="pageLocation">运营系统->支付机构管理->新增</span></div>
        <div class="pageTitle">支付机构新增</div>

        <!-- start产品详细页 -->
        <div id="agencyinfoAdd" style="display: block">
        <form action="doAdd.j" method="post" id="aaa" >
   				 <ul class="addNewProductUl pageUl detail">
                        <li>
                            <span class="labelName">支付机构名称：</span>
                            <input type="text" maxlength="20" name = "agencyName" value="" class="userText"></input>
                            <span class="require">*</span>
                             <span class="point">请填写必填项</span>
                        </li>
                        <li>
                            <span class="labelName">支付机构编码：</span>
                            <input type="text"  maxlength="15" name = "agencyCode" value="" class="userText"></input>
                            <span class="require">*</span>
                            <span class="point">请填写必填项</span>
                        </li>
                        <div class="clear"></div>
                        <li>
                    		...
                    		<select name="agencyType" data-placeholder="请选择..." class="chosen_select150">
                       ...
                       <li>
                            <span class="labelName">支付地址：</span>
                             <input type="text" maxlength="100" name = "payUrl" value="" class="userText"></input>
                            <span class="require">*</span>
                            <span class="point">请填写必填项</span>
                       </li>
                       <div class="clear"></div>
                       <li>
                            <span class="labelName">退款地址：</span>
                             <input type="text" maxlength="100" name = "refundUrl" value="" class="userText"></input>
                            <span class="require">*</span>
                            <span class="point">请填写必填项</span>
                       </li>
                       <li>
                            <span class="labelName">退款查询地址：</span>
                            <input type="text" maxlength="100" name = "queryRefundUrl" value="" class="userText"></input>
                            <span class="require">*</span>
                            <span class="point">请填写必填项</span>
                       </li>
                            <div class="clear"></div>
                       <li>
                            <span class="labelName">订单查询地址：</span>
                             <input type="text" maxlength="100" name = "queryUrl" value="" class="userText"></input>
                            <span class="require">*</span>
                            <span class="point">请填写必填项</span>
                       </li>
                       <li>
                            <span class="labelName">手机预支付地址：</span>
                             <input type="text" maxlength="100" name = "prepayUrl" value="" class="userText"></input>
                            <span class="require">*</span>
                            <span class="point">请填写必填项</span>
                       </li>
                            <div class="clear"></div>
                       <li>
                            <span class="labelName">手机验证码地址：</span>
                             <input type="text" maxlength="100" name = "sendPhoneUrl"  value="" class="userText"></input>
                            <span class="require">*</span>
                            <span class="point">请填写必填项</span>
                       </li>
                    </ul>
