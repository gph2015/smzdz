...
<%@ include file="../common/head.jsp"%>
    <div id="rightContent">
        ...
        <div class="pageTitle">手续费对账列表</div>
        ...
        <div id="transactionList" style="display: block">
            <form action="payCheckFee.j" method="post" id ="queryForm"  refreshId="list-page"  class="ajaxfrm" >
                ...
                <div class="tableWrap">
                    <table class="tableList">
                        <tr>
                            ...
                            <th nowrap="nowrap">平台手续费总金额</th>
                            <th nowrap="nowrap">对方总笔数</th>
                            <th nowrap="nowrap">对方手续费总金额</th>
                        ...
                        <c:forEach items="${resultList}" var="item" varStatus="xh">
                            <tr>
                                ...
                                <td nowrap="nowrap"><fmt:formatNumber value="${item.totalFee}" pattern="#,##0.00"/></td>
                                <td nowrap="nowrap">${item.outTotalNum}</td>
                                <td nowrap="nowrap"><fmt:formatNumber value="${item.outTotalFee}" pattern="#,##0.00"/></td>
                                ...
                                <td nowrap="nowrap"><c:if test="${item.status==2}"><a href="payCheckFeeDiff.j?f[checkDate]=${item.checkDate}&f[agencyCode]=${item.agencyCode}&f[bizCode]=${item.bizCode}">详情</a></c:if></td>
                            </tr>
                        </c:forEach>
                    </table>
